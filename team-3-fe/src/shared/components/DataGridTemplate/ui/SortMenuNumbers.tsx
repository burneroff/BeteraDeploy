...
import { ArrowUpIcon } from '@/shared/icons/ArrowUpIcon.tsx';
import { ArrowDownIcon } from '@/shared/icons/ArrowDownIcon.tsx';
...
/**
 * Сортировка для чисел (По возрастанию / По убыванию / По умолчанию)
 */
export const SortMenuNumbers: React.FC<Props> = ({ field, currentSort, onChange, hideMenu }) => {
  const apiRef = useGridApiContext();

  const options = [
    { label: 'По возрастанию', icon: <ArrowUpIcon />, sort: 'asc' as const },
    { label: 'По убыванию', icon: <ArrowDownIcon />, sort: 'desc' as const },
...
export default SortMenuNumbers;
